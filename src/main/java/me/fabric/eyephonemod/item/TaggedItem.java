...
public abstract class TaggedItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        return interact(world, user, hand, stackInHand) ? super.use(world, user, hand) : TypedActionResult.fail(stackInHand);
    }

    public abstract void serializeStack(@NotNull ItemStack itemStack, @NotNull CompoundTag compoundTag);

    public abstract boolean interact(World world, PlayerEntity user, Hand hand, ItemStack itemStack);
}
